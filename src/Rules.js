...
const fullHouse = new FullHouse({ score: 25, description: '25 ponits for a Full House' });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: '30 ponits for a Samll Straight' });
const largeStraight = new LargeStraight({ score: 40, description: '40 points for a Large Straight' });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: '50 ponits for a Yahtzee' });
